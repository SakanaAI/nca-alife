...
group.add_argument("--d_state", type=int, default=8)
...
group.add_argument("--temperature", type=float, default=1e-3)
...
def main(args):
    sim = DNCA(grid_size=args.grid_size, d_state=args.d_state, n_groups=args.n_groups, identity_bias=args.identity_bias, temperature=args.temperature)
